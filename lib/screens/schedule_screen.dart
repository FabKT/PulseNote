...
class _ScheduleScreenState extends State<ScheduleScreen>
                ...
                builder: (_, state, __) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (ctx, i) => ScheduleCard(
                      ...
                      onEdit: () => _showEditDialog(ctx, filtered[i]),
  ...
  Future<void> _showEditDialog(BuildContext ctx, ScheduleModel schedule) async {
    await showModalBottomSheet(
      context: ctx,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
...
// -?š' En-tête avec tabs -?š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š?
...
// -?š' État vide -?š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š?
...
// -?š' Bottom sheet de création d'un créneau -?š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š-š?
...
class _CreateScheduleSheetState extends State<_CreateScheduleSheet> {
  ...
  final TextEditingController _recordingNameCtrl = TextEditingController();

  @override
  void initState() {
    super.initState();
    final schedule = widget.scheduleToEdit;
    _mode = schedule?.mode ?? widget.initialMode;
    _start = schedule?.startTime ?? _start;
    _end = schedule?.endTime ?? _end;
    _selectedKeywordIds.addAll(schedule?.keywordIds ?? const []);
    _recordingNameCtrl.text = schedule?.recordingName ?? '';
  }

  @override
  void dispose() {
    _recordingNameCtrl.dispose();
    super.dispose();
  }
  ...
  void _save(AppState state) {
    ...
    final schedule = ScheduleModel(
      ...
      recordingName: _recordingNameCtrl.text.trim().isEmpty
          ? null
          : _recordingNameCtrl.text.trim(),
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const SizedBox(height: 20),
          TextField(
            controller: _recordingNameCtrl,
            textInputAction: TextInputAction.done,
            style: const TextStyle(color: AppTheme.text),
            decoration: InputDecoration(
              labelText: 'Nom de l\'enregistrement',
              hintText: 'Ex. R\u00e9union \u00e9quipe',
              filled: true,
          ...
          Row(children: [
            ...
            Expanded(
              child: FilledButton(
                ...
                child: Text(widget.scheduleToEdit == null
                    ? 'Créer le créneau'
                    : 'Enregistrer'),
              ),
            ),
