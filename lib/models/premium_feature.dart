...
extension PremiumFeatureLabels on PremiumFeature {
  String get title => switch (this) {
        PremiumFeature.instantTranscription => 'Transcription instantanée',
  ...
  String get description => switch (this) {
        PremiumFeature.instantTranscription =>
          'Affichez le texte en direct pendant un enregistrement manuel.',
